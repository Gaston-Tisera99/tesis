...
function Header()
{
    ...
    $this->Image('./../imagenes/logo.jpg',0,0,70); //imagen(archivo, png/jpg || x,y,tamaño)
    $this->setXY(60,15);
    $this->Cell(100,8,'Nombre del Reporte',0,1,'C',0);
    $this->Image('./../imagenes/logo.jpg',150,10,35); //imagen(archivo, png/jpg || x,y,tamaño)
    $this->Ln(40);
}
...
$pdf->Cell(60,8,'Escobillon Estandar','B',0,'C',1);
