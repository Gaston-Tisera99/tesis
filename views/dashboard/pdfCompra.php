<?php
  ...
  function Header()
  {
     ...
     $this->Cell(110, 15, mb_convert_encoding('Orden de Compra', 'ISO-8859-1', 'UTF-8'), 0, 0, 'C', 0);  
     $this->Ln(3); 
     $this->SetTextColor(103);
 ...
 while ($ver=$result->fetch_assoc()):
  ...
  $pdf->SetFont('Arial','',12);
      ...
      $pdf->setX(15);
      $proveedor = utf8_decode($ver['razon_social']);
      $comprobante = $ver['id'];
      $fecha = $ver['fecha'];
 endwhile;
    ...
    $pdf->Cell(0, 10, 'Proveedor: ' . $proveedor, 0, 1, 'R');
    $pdf->SetX(15);
    $pdf->SetY(55);
